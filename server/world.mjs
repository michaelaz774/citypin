...
import { S2C, PLAYER_REC, DEFAULT_NAME, cleanName, writePlayer, encodeRoster } from '../shared/protocol.mjs';
...
export class World {
  ...
  join(now) {
    ...
    this.alive[slot] = 1; this.px[slot] = 0; this.py[slot] = 0; this.pz[slot] = 0; this.flags[slot] = 0; this.lastSeen[slot] = now; this.hasState[slot] = 0; this.lastJump[slot] = -1e12; this.names[slot] = DEFAULT_NAME; this.token[slot] = 0;
    return slot + 1;
  }
  leave(id) {
